...
- Structure clearly with Markdown: short paragraphs, headings, and bullet/numbered lists where they help.
...
const CHAT_MODE_INSTRUCTIONS = `Task: Answer the user's question as a focused first-pass overview.
- Do not try to cover every related detail in one response. Give the key idea first, then the most useful supporting points.
- Keep the answer compact enough for the user to continue exploring naturally. Prefer 2-5 short paragraphs or a short bullet list.
- End with a brief transition that invites the user to go deeper, but do not include a separate list of suggested questions in the answer body.`;
...
- Give a complete answer for this preset task; never stop mid-thought.`,
