...
const ERROR_MESSAGES: Record<ErrorCodeType, string> = {
  ...
  AUTH_EMAIL_DOMAIN: "Email của bạn chưa được cấp quyền truy cập hệ thống nội bộ.",
  ...
  ACADEMIC_CONFLICT: "Không thể thay đổi vì bản ghi đang được sinh viên hoặc tài liệu sử dụng.",
  ACCESS_EMAIL_NOT_FOUND: "Không tìm thấy email truy cập.",
  CANNOT_REVOKE_SELF_ACCESS: "Bạn không thể thu hồi quyền truy cập của chính email mình.",
  ...
  CURRICULUM_NOT_ENROLLED: "Môn học không thuộc ngành, học kỳ hoặc danh sách môn đã chọn của bạn.",
};
